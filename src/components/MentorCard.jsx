  ...
  return (
    <Link to={`/mentors/${id}`}>
      <section className="bg-white w-full h-full border-red-500 text-primary-black">
        <div className="h-[50%] border border-orange-500 flex justify-center items-center">
        ...
        {/* details section */}
        <div className="h-[50%] border flex flex-col justify-start items-center gap-6 px-4 py-4 relative">
