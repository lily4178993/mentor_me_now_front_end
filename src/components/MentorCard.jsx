...
const MentorCard = ({ id, name, image, about }) => {
  ...
  return (
    <Link to={`/mentors/${id}`}>
      <section className="bg-white border-red-500 h-auto text-primary-black">
        ...
        <div className="h-auto flex flex-col justify-start items-center gap-4 p-8 relative">
          ...
          <div className="flex h-auto items-center gap-4">
            <button
              type="button"
              className="border text-xs text-primary-gray hover:text-primary-black focus:text-primary-black hover:animate-bounce focus:animate-bounce px-3 py-2 bg-transparent border-primary-gray rounded-full"
            >
              S
            </button>
            <button
