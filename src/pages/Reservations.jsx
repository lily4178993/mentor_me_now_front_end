  ...
  return (
    <section className="w-full h-full m-auto px-2 md:p-2 relative overflow-hidden">
      ...
      {reservations && reservations.length > 0 ? (
        <ul className="flex flex-wrap justify-center gap-x-2 gap-y-3 md:gap-y-5">
          {reservations.map((reservation) => {
            ...
            return (
              <li
                key={reservation.id}
                className="min-w-64 bg-primary-green shadow-2xl rounded-md"
              >
                {mentor ? (
                  <div className="flex flex-col">
                    ...
                    <div className="text-xs text-white p-2 relative">
                      <span className="text-xs text-center py-2 block">
                        Meeting
                      </span>
                  ...
                  <p>
                    <AlertStatus
                      alertMessage="We couldn`t find a mentor matching your request. It seems
                    like you haven`t reserved a mentor in the usual manner."
                      className="absolute w-full h-full z-10 top-0 left-0 backdrop-blur-sm bg-primary-black/50 flex items-center justify-center"
                    />
                  </p>
                )}
              </li>
        ...
        <p>
          <AlertStatus
            alertMessage="We couldn`t find any reservations. It looks like you haven`t reserved
          any mentors yet."
            className="absolute w-full h-full z-10 top-0 left-0 backdrop-blur-sm bg-primary-black/50 flex items-center justify-center"
          />
        </p>
